 ...
 * 功能：
 */
public class BuyOfSchoolDetailShoppingAdapter3 extends AbstractBaseAdapter<BuyOfSchoolDetailShopping.ProductsBean>{

    public BuyOfSchoolDetailShoppingAdapter3(Context context) {
        super(context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final BuyOfSchoolDetailShopping.ProductsBean item = getItem(position);
        if (item != null) {
            if (position==0){

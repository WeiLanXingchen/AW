 ...
 * 功能：
 */
public class BuyOfSchoolDetailShoppingAdapter2 extends AbstractBaseAdapter<BuyOfSchoolDetailShopping.OtoBean>{

    public BuyOfSchoolDetailShoppingAdapter2(Context context) {
        super(context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final BuyOfSchoolDetailShopping.OtoBean item = getItem(position);
        if (item != null) {
            if (position==0){

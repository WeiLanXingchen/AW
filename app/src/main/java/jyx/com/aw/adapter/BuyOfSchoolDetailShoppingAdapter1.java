 ...
 * 功能：
 */
public class BuyOfSchoolDetailShoppingAdapter1 extends AbstractBaseAdapter<BuyOfSchoolDetailShopping.GeneralBean>{

    public BuyOfSchoolDetailShoppingAdapter1(Context context) {
        super(context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final BuyOfSchoolDetailShopping.GeneralBean item = getItem(position);
        if (item != null) {
            if (position==0){

 ...
 * 一般就一个标题栏的列表界面
 */
public abstract class BaseFixedListFragment<T> extends BaseRefreshFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        setContentView(R.layout.common_base_fixed_listview);
    ...
    protected void initViews() {
        ...
        mLoadMoreHelper = new LoadMoreHelper(mListView) {
            ...
            public void onLoadMoreBegin() {
                BaseFixedListFragment.this.onLoadMoreBegin();
            }
        };
    ...
    public class ListAdapter extends AbstractBaseAdapter<T> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            return BaseFixedListFragment.this.getView(position, convertView, parent);
        }
    }

 ...
 * 功能：
 */
public class ListFriendsFragment1 extends BaseFragment{
    private static ListFriendsFragment1 instance=null;
    public static ListFriendsFragment1 newInstance() {
        if(instance==null){
            instance= new ListFriendsFragment1();
        }
        return instance;
    }
    public ListFriendsFragment1(){}
    @Override
